...
import { DBotStoreProvider, mockDBotStore } from 'Stores/useStore';
...
describe('RecentComponent', () => {
    ...
    it('Should render SaveModal in desktop', () => {
        ...
        const modal_text = screen.getByText(
            /Enter your Binarytool Bot name, choose to save on your computer or Google Drive/i
        );
