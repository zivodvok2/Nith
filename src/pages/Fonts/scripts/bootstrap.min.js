...
!(function (e, t) {
    ...
    function l(e, o, c) {
        ...
        return (
            (u || (!u && !c)) &&
                (('body' !== a(o) || p(l)) &&
                    (d = o !== n(o) && i(o) ? { scrollLeft: o.scrollLeft, scrollTop: o.scrollTop } : r(o)),
                i(o) ? (((m = t(o)).x += o.clientLeft), (m.y += o.clientTop)) : l && (m.x = f(l))),
    ...
    function x(e, o) {
        if ('viewport' === o) {
            ...
            o &&
                ((p = o.width),
                (a = o.height),
                /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || ((l = o.offsetLeft), (u = o.offsetTop))),
                (e = w((e = { width: p, height: a, x: l + f(e), y: u })));
        } else
            i(o)
                ? (((e = t(o)).top += o.clientTop),
                  (e.left += o.clientLeft),
                                ...
                                for (
                                    ...
                                    if (!0 === s.reset) (s.reset = !1), (t = -1);
                                        ...
                                        (r = void 0 === r ? {} : r),
                                            (n = n.name),
                                            'function' == typeof e &&
                                                (s = e({ state: s, options: r, name: n, instance: p }) || s);
                                    }
                        }
                    },
                    update: b(function () {
    ...
    function W(e) {
        ...
        e.roundOffsets
            ? ((e = window.devicePixelRatio || 1),
              (e = { x: Math.round(a.x * e) / e || 0, y: Math.round(a.y * e) / e || 0 }))
            : (e = a);
        var l = e;
        ...
        if (p) {
            var b = g(r);
            b === n(r) && (b = s(r)),
                'top' === i && ((h = 'bottom'), (l -= b.clientHeight - o.height), (l *= c ? 1 : -1)),
                'left' === i && ((m = 'right'), (e -= b.clientWidth - o.width), (e *= c ? 1 : -1));
        }
        return (
            ...
            c
                ...
                : Object.assign(
                      Object.assign({}, r),
                      {},
                      (((t = {})[h] = a ? l + 'px' : ''), (t[m] = u ? e + 'px' : ''), (t.transform = ''), t)
                  )
        );
    }
    function A(e) {
                            ...
                            'auto' === y(n)
                                ? (function (e, t) {
                                      ...
                                      var c = i.reduce(function (t, i) {
                                          return (
                                              (t[i] = L(e, { placement: i, boundary: n, rootBoundary: r, padding: o })[
                                                  y(i)
                                              ]),
                                              t
                                          );
        ...
        Q = {
            ...
            fn: function (e) {
                ...
                var l = t.modifiersData.popperOffsets,
                    ...
                    h =
                        'function' == typeof s
                            ? s(Object.assign(Object.assign({}, t.rects), {}, { placement: t.placement }))
                            : s;
                if (((s = { x: 0, y: 0 }), l)) {
                    if (o) {
                        var v = 'y' === p ? 'top' : 'left',
            ...
            fn: function (e) {
                ...
                if (((i = 0 <= ['left', 'right'].indexOf(i) ? 'height' : 'width'), r && o)) {
                    ...
                    (o = o[a] - n.rects.reference[a]),
                        (l =
                            (r = (r = g(r)) ? ('y' === a ? r.clientHeight || 0 : r.clientWidth || 0) : 0) / 2 -
                            f[i] / 2 +
                            (l / 2 - o / 2)),
            ...
            effect: function (e) {
                ...
                if (
                    ...
                    O(t.elements.popper, r) &&
                        ((t.elements.arrow = r),
                        (t.modifiersData[e + '#persistent'] = { padding: D('number' != typeof n ? n : P(n, T)) }));
                }
            },
            requires: ['popperOffsets'],
    ...
    class Mt extends V {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    U.next(this._element, kt)[0] || U.prev(this._element, kt)[0] || U.findOne(kt, this._parent)),
    ...
    var rt = function (t, n) {
        ...
        zt = {
            ...
            Cover: function (t, n) {
                ...
                function i(t, n) {
                    E(t.parentElement, { background: n ? '' : 'center/cover no-repeat url("' + t.src + '")' }),
                        E(t, { display: n ? '' : 'none' });
                }
                return {
            ...
            LazyLoad: function (t, n, e) {
                ...
                function l(n, i, o, r) {
                    S(o.slide, D.loading),
                        r || (b(i), E(n, { display: '' }), t.emit(e + ':loaded', n).emit('resize')),
                        a && f();
                }
                return {
                    required: s.lazyLoad,
    ...
    return (function (e) {
                            ...
                            value: function () {
                                ...
                                if ('undefined' != typeof Promise) {
                                    ...
                                    (t.url = t.responseURL = (0, v.getCurrentUrl)()),
                                        ...
                                        (0, v.markSwupElements)(document.documentElement, this.options.containers),
                        ...
                        },
                        {
                            ...
                            value: function (e) {
                                if (e.metaKey || e.ctrlKey || e.shiftKey || e.altKey)
                                    ...
                                    if (t.getAddress() == (0, v.getCurrentUrl)() || '' == t.getAddress())
                                        '' != t.getHash()
                                            ? (this.triggerEvent('samePageWithHash', e),
                                              null != document.querySelector(t.getHash())
                                                  ...
                                                  : console.warn('Element for offset not found (' + t.getHash() + ')'))
                                        ...
                                        this.loadPage({ url: t.getAddress(), customTransition: n }, !1);
                                    }
                                }
                            },
                        },
                        {
                            ...
                            value: function (e) {
                                if (!this.options.skipPopStateHandling(e)) {
                                    ...
                                    '' !== t.getHash() ? (this.scrollToElement = t.getHash()) : e.preventDefault(),
            ...
            t.default = function (e, t) {
                ...
                this.triggerEvent('transitionStart', t),
                    null != e.customTransition
                        ? (this.updateTransition(window.location.pathname, e.url, e.customTransition),
                          document.documentElement.classList.add('to-' + (0, r.classify)(e.customTransition)))
                    ...
                    !t || this.options.animateHistoryBrowsing
                        ? (function () {
                              if (
                                  ...
                                  document.documentElement.classList.add('to-' + (0, r.classify)(e.url)),
                                  ...
                                  var i;
                                  (i = null != n.scrollToElement ? e.url + n.scrollToElement : e.url),
                        ...
                        : (a =
                              this.preloadPromise && this.preloadPromise.route == e.url
                                  ...
                                  : new Promise(function (t, o) {
                                        (0, r.fetch)(i({}, e, { headers: n.options.requestHeaders }), function (i) {
        ...
        function (e, t, n) {
            ...
            t.default = function (e, t) {
                ...
                for (var a = 0; a < e.blocks.length; a++)
                    document.body.querySelector('[data-swup="' + a + '"]').outerHTML = e.blocks[a];
                if (
        ...
        function (e, t, n) {
            ...
            t.default = function (e) {
                ...
                return n
                    ? ((n.responseURL = e.responseURL ? e.responseURL : window.location.href), n)
                    : (console.warn(
                            ...
                            (n.preloadPage = function (e) {
                                ...
                                return new Promise(function (e, n) {
                                    if (r.getAddress() != (0, f.getCurrentUrl)() && !t.cache.exists(r.getAddress())) {
                                        (0, f.fetch)(
                                            { url: r.getAddress(), headers: t.options.requestHeaders },
                                            function (o) {
                                                if (o.status === 500) {
